...
class Application(object):
    def __init__(self, parent):
        ...
        self.canvas =  Canvas(self.parent, bg='black',  width='675', height=520)
        ...
        self.scrolly = Scrollbar(self.parent, orient = VERTICAL, command=self.canvas.yview)
        self.scrollx = Scrollbar(self.parent, orient=HORIZONTAL, command=self.canvas.xview)
